...
//   },
//   {
//     sql_expression: "CASE WHEN cache_hit = false THEN 'MISS' ELSE 'HIT' END",
//   },
//   {
//     sql_expression: 'se',
//   },
...
//   },
//   {
//     sql_expression: 'dim_ticket.sla_id',
//   },
//   {
...
//   },
//   {
//     sql_expression: 'spillover_issue_id',
//   },
//   {
//     sql_expression:
...
//   {
//     sql_expression:
//       "CASE WHEN state = 'closed' THEN actual_close_date ELSE COALESCE((custom_fields ->> 'ctype__created_at_cfid')::TIMESTAMP, (custom_fields ->> 'ctype__opened_at_cfid')::TIMESTAMP, created_date) END",
//   },
//   {
//     sql_expression: 'sync_unit_id',
//   },
//   {
//     sql_expression:
...
//   },
//   {
//     sql_expression: 'regexp_split_to_array(tnt__sub_regions, \'"|\\["|"\\]\')',
//   },
//   {
...
//   },
//   {
//     sql_expression: 'start',
//   },
//   {
//     sql_expression: 'total_time_spent',
//   },
//   {
//     sql_expression:
//       "COALESCE((custom_fields->>'ctype__closed_at_cfid')::TIMESTAMP,actual_close_date)::TIMESTAMP",
//   },
//   {
...
//   {
//     sql_expression:
//       "CASE WHEN DATEDIFF ('day', modified_date, CURRENT_DATE) <= 1 THEN 1 WHEN DATEDIFF ('day', modified_date, CURRENT_DATE) <= 4 THEN 2 WHEN DATEDIFF ('day', modified_date, CURRENT_DATE) <= 8 THEN 3 WHEN ( DATEDIFF ('day', modified_date, CURRENT_DATE) <= 15 AND DATEDIFF ('day', modified_date, CURRENT_DATE) <= 30 ) THEN 4 ELSE 5 END",
//   },
//   {
...
//   },
//   {
//     sql_expression: "(CASE WHEN links_json != '[]' THEN 'yes' ELSE 'no' END)",
//   },
//   {
...
//   },
//   {
//     sql_expression: "json_extract_string(fact_issue.stage_json, '$.stage_id')",
//   },
//   {
...
//   },
//   {
//     sql_expression: 'custom_metric_used',
//   },
//   {
...
//   },
//   {
//     sql_expression: "DATE_TRUNC('month',close_date)",
//   },
//   {
//     sql_expression: 'event_week_start',
//   },
//   {
//     sql_expression: 'dim_ticket.modified_by_id',
//   },
//   {
...
//   },
//   {
//     sql_expression: 'spam_prediction',
//   },
//   {
//     sql_expression:
...
//   {
//     sql_expression:
//       "CASE WHEN json_extract(tags_json, '$[*].tag_id') LIKE '%\"don:core:dvrv-us-1:devo/0:tag/8036\"%' THEN 'AI Classified' ELSE 'Not AI Classified' END",
//   },
//   {
//     sql_expression:
//       "CAST(json_extract_string(dim_ticket.tags_json, '$[*].tag_id') AS VARCHAR[])",
//   },
//   {
...
//   },
//   {
//     sql_expression: 'ROUND(confidence_score, 1)',
//   },
//   {
...
//   },
//   {
//     sql_expression: 'module_name',
//   },
//   {
//     sql_expression: 'health_state_duration_mean',
//   },
//   {
//     sql_expression: 'ticket_category',
//   },
//   {
//     sql_expression: 'marketplace_item_slug',
//   },
//   {
...
//   },
//   {
//     sql_expression: "DATE_TRUNCT('day',created_date)",
//   },
//   {
//     sql_expression:
...
//   },
//   {
//     sql_expression: "custom_fields -> 'ctype__x1260822517229_cfid'",
//   },
//   {
//     sql_expression: "DATE_TRUNC('day', actual_close_date)",
//   },
...
//   {
//     sql_expression:
//       " CASE WHEN recipe_version_su = 'SyncRun_RecipeVersionEnumV2' THEN 'V2' WHEN recipe_version_su = 'SyncRun_RecipeVersionEnumV3' THEN 'V3' ELSE 'Unknown' END",
//   },
//   {
//     sql_expression: 'work_id',
//   },
//   {
...
//   },
//   {
//     sql_expression: 'dev_org_display_name',
//   },
//   {
//     sql_expression: 'metric_type',
//   },
//   {
//     sql_expression: 'account_selector_exists',
//   },
//   {
...
//   },
//   {
//     sql_expression: "date_trunc('day', dim_ticket.target_close_date)",
//   },
//   {
...
//   },
//   {
//     sql_expression: "CASE WHEN is_spam THEN 'Yes' ELSE 'No' END",
//   },
//   {
...
//   {
//     sql_expression:
//       "STRING_SPLIT(TRANSLATE(JSON_EXTRACT(tags_json, '$[*].tag_id')::TEXT, '\"[]', '' ), ',')",
//   },
//   {
...
//   },
//   {
//     sql_expression: 'enhancement_category',
//   },
//   {
...
//   {
//     sql_expression:
//       "CASE WHEN DATEDIFF('day', modified_date, CURRENT_DATE) <= 1 THEN '1 day' WHEN DATEDIFF('day', modified_date, CURRENT_DATE) <= 4 THEN '4-7 days' WHEN DATEDIFF('day', modified_date, CURRENT_DATE) <= 8 THEN '8-15 days' WHEN ( DATEDIFF('day', modified_date, CURRENT_DATE) <= 15 AND DATEDIFF('day', modified_date, CURRENT_DATE) <= 30 ) THEN '15-30 days' ELSE '>30 days' END",
//   },
//   {
...
//   {
//     sql_expression:
//       "CASE WHEN state = 'closed' THEN COALESCE((custom_fields->>'ctype__closed_at_cfid')::TIMESTAMP,actual_close_date)::TIMESTAMP ELSE COALESCE((custom_fields ->> 'ctype__created_at_cfid')::TIMESTAMP, (custom_fields ->> 'ctype__opened_at_cfid')::TIMESTAMP, created_date) END",
//   },
//   {
...
//   },
//   {
//     sql_expression: "DATE_TRUNC('month',modified_date)",
//   },
//   {
//     sql_expression:
...
//   },
//   {
//     sql_expression: 'dim_ticket.needs_response',
//   },
//   {
...
//   },
//   {
//     sql_expression: "DATEDIFF('seconds', record_date, target_close_date)",
//   },
//   {
//     sql_expression:
...
//   },
//   {
//     sql_expression: "CASE WHEN spam_prediction THEN 'Yes' ELSE 'No' END",
//   },
//   {
...
//   },
//   {
//     sql_expression: "custom_fields -> 'ctype__x1260822517949_cfid'",
//   },
//   {
...
//   },
//   {
//     sql_expression: 'issue_subtype',
//   },
//   {
//     sql_expression: "case when state != 'closed' then 'Open' else Closed ",
//   },
//   {
...
//   {
//     sql_expression:
//       "SUBSTR(MONTHNAME(old_record_date), 1, 3) || ' ' || CAST(YEAR(old_record_date) AS VARCHAR)",
//   },
//   {
//     sql_expression: 'lost_date_quarter',
//   },
//   {
//     sql_expression: 'avg_time_to_deploy',
//   },
//   {
...
//   {
//     sql_expression:
//       "list_distinct(CAST(json_extract_string(dim_ticket.links_json, '$[*].target_object_type') AS VARCHAR[]))",
//   },
//   {
//     sql_expression: 'mao',
//   },
...
//   },
//   {
//     sql_expression: 'ticket_date',
//   },
//   {
//     sql_expression: 'ticket_type',
//   },
//   {
...
//   {
//     sql_expression:
//       "DATE_TRUNC('week', CASE WHEN range_state = 'closed' THEN (actual_close_date)::TIMESTAMP ELSE COALESCE((custom_fields ->> 'ctype__created_at_cfid')::TIMESTAMP, (custom_fields ->> 'ctype__opened_at_cfid')::TIMESTAMP, created_date) END)",
//   },
//   {
//     sql_expression: 'problem_area',
//   },
//   {
//     sql_expression: 'source_type',
//   },
//   {
...
//   },
//   {
//     sql_expression: 'spilledover_sprint_id',
//   },
//   {
...
//   {
//     sql_expression:
//       "CASE WHEN source = 'tickets' THEN (actual_close_date)::TIMESTAMP ELSE  COALESCE((custom_fields ->> 'ctype__created_at_cfid')::TIMESTAMP, (custom_fields ->> 'ctype__opened_at_cfid')::TIMESTAMP, created_date) END",
//   },
//   {
...
//   },
//   {
//     sql_expression: 'dim_ticket.group',
//   },
//   {
//     sql_expression: 'dim_ticket.sla_tracker_id',
//   },
//   {
...
//   },
//   {
//     sql_expression: "json_extract_string(dim_ticket.stage_json, '$.stage_id')",
//   },
//   {
...
//   },
//   {
//     sql_expression: 'dim_ticket.severity',
//   },
//   {
...
//   },
//   {
//     sql_expression: 'dim_ticket.created_by_id',
//   },
//   {
//     sql_expression: "date_trunc('week', dim_ticket.actual_close_date)",
//   },
//   {
//     sql_expression:
//       "cast(json_extract_string(dim_ticket.sla_summary, '$.target_time') as timestamp)",
//   },
//   {
...
//   },
//   {
//     sql_expression: 'ltp_obj_id',
//   },
//   {
//     sql_expression: 'created_hour_ampm',
//   },
//   {
//     sql_expression: 'CAST(started_at AS DATE)',
//   },
//   {
...
//   },
//   {
//     sql_expression: 'dev_org_dipslay_name',
//   },
//   {
//     sql_expression:
...
//   },
//   {
//     sql_expression: 'last_message_timestamp',
//   },
//   {
//     sql_expression: 'part_id_secondary',
//   },
//   {
//     sql_expression: 'touchpoint_date',
//   },
//   {
//     sql_expression: 'dim_ticket.reported_by_ids',
//   },
//   {
//     sql_expression: "date_trunc('week', dim_ticket.modified_date)",
//   },
//   {
...
//   },
//   {
//     sql_expression: "DATE_DIFF('day', created_date, actual_close_date)",
//   },
//   {
...
//   {
//     sql_expression:
//       "CASE WHEN state = 'closed' THEN COALESCE((custom_fields->>'ctype__closed_at_cfid')::TIMESTAMP,actual_close_date) ELSE COALESCE((custom_fields ->> 'ctype__created_at_cfid')::TIMESTAMP, (custom_fields ->> 'ctype__opened_at_cfid')::TIMESTAMP, created_date) END",
//   },
//   {
//     sql_expression:
...
//   {
//     sql_expression:
//       "CASE WHEN range_state = 'closed' THEN (actual_close_date)::TIMESTAMP ELSE COALESCE((custom_fields ->> 'ctype__created_at_cfid')::TIMESTAMP, (custom_fields ->> 'ctype__opened_at_cfid')::TIMESTAMP, created_date) END",
//   },
//   {
...
//   },
//   {
//     sql_expression: 'policy_type',
//   },
//   {
//     sql_expression: 'api_url',
//   },
//   {
//     sql_expression: "stage_json->'stage_id'",
//   },
//   {
...
//   {
//     sql_expression:
//       "CASE WHEN state = 'closed' THEN (actual_close_date)::TIMESTAMP ELSE COALESCE((custom_fields ->> 'ctype__created_at_cfid')::TIMESTAMP, (custom_fields ->> 'ctype__opened_at_cfid')::TIMESTAMP, created_date) END",
//   },
//   {
...
//   {
//     sql_expression:
//       'IFNULL(time_to_open, 0) + IFNULL(time_to_review, 0) + IFNULL(time_to_approve, 0) + IFNULL(time_to_merge, 0) + IFNULL(avg_time_to_deploy, 0)',
//   },
//   {
//     sql_expression: "CONCAT(monthname(date),'-',year(date))",
//   },
//   {
//     sql_expression: 'dim_ticket.rev_oid',
//   },
//   {
//     sql_expression: "date_trunc('day', dim_ticket.last_internal_comment_date)",
//   },
//   {
//     sql_expression: 'dim_ticket.applies_to_part_id',
//   },
//   {
...
//   {
//     sql_expression:
//       "CASE WHEN severity_id = 1 THEN 'Blocker' WHEN severity_id = 2 THEN 'High' WHEN severity_id = 3 THEN 'Medium' WHEN severity_id = 4 THEN 'Low' END",
//   },
//   {
...
//   {
//     sql_expression:
//       "DATE_TRUNC('week', CASE WHEN state = 'closed' THEN (actual_close_date)::TIMESTAMP ELSE COALESCE((custom_fields ->> 'ctype__created_at_cfid')::TIMESTAMP, (custom_fields ->> 'ctype__opened_at_cfid')::TIMESTAMP, created_date) END)",
//   },
//   {
...
//   },
//   {
//     sql_expression: 'conversation_age_category',
//   },
//   {
//     sql_expression:
...
//   {
//     sql_expression:
//       'CASE WHEN type is not null THEN         CONCAT(            UPPER(SUBSTR(type, 1, 1)),              LOWER(SUBSTR(type, 2))         )  END',
//   },
//   {
//     sql_expression:
...
//   {
//     sql_expression:
//       "JSON_EXTRACT_STRING(custom_fields, '$.tnt__forecast_category')",
//   },
//   {
...
//   {
//     sql_expression:
//       "cast(json_extract_string(dim_ticket.staged_info, '$.is_staged') as boolean)",
//   },
//   {
...
//   {
//     sql_expression:
//       "'platform=WEB&0026vk=' || version_key || '&0026si=' || session_id",
//   },
//   {
...
//   },
//   {
//     sql_expression: 'mitigated_vs_closed',
//   },
//   {
//     sql_expression: 'issue',
//   },
...
//   {
//     sql_expression:
//       "COALESCE((custom_fields->>'ctype__closed_at_cfid')::TIMESTAMP,actual_close_date)",
//   },
//   {
...
//   },
//   {
//     sql_expression: "custom_fields -> 'ctype__x20331512708123_cfid'",
//   },
//   {
//     sql_expression:
...
//   },
//   {
//     sql_expression: 'devu_ids',
//   },
//   {
//     sql_expression: 'in_sprint_limit',
//   },
//   {
//     sql_expression: 'pipeline_created_date_quarter',
//   },
//   {
//     sql_expression: 'dim_ticket.object_type',
//   },
//   {
//     sql_expression: 'dim_ticket.channels',
//   },
//   {
...
//   {
//     sql_expression:
//       "COALESCE((custom_fields ->> 'ctype__created_at_cfid')::TIMESTAMP, (custom_fields ->> 'ctype__opened_at_cfid')::TIMESTAMP, created_date) ",
//   },
//   {
...
//   },
//   {
//     sql_expression: "concat(monthname(activity_date),'-',year(activity_date))",
//   },
//   {
//     sql_expression: "date_trunc('week', dim_ticket.created_date)",
//   },
//   {
//     sql_expression: 'dim_ticket.reported_by_id',
//   },
//   {
...
//   {
//     sql_expression:
//       "DATE_TRUNC('week', COALESCE((custom_fields ->> 'ctype__created_at_cfid')::TIMESTAMP, (custom_fields ->> 'ctype__opened_at_cfid')::TIMESTAMP, created_date))",
//   },
//   {
//     sql_expression: "DATE_TRUNC('month',actual_close_date)",
//   },
//   {
...
//   {
//     sql_expression:
//       "REPLACE(REPLACE(ARRAY_TO_STRING(JSON_EXTRACT(tags_json, '$[*].tag_id'), ''), '\"', ''), ',', '')",
//   },
//   {
//     sql_expression:
...
//   },
//   {
//     sql_expression: 'dim_ticket.source_channel',
//   },
//   {
...
//   {
//     sql_expression:
//       "SUBSTRING(MONTHNAME(old_record_date), 1, 3) || ' ' || CAST(YEAR(old_record_date) AS VARCHAR)",
//   },
//   {
...
//   {
//     sql_expression:
//       " CASE WHEN recipe_version_sh = 'SyncRun_RecipeVersionEnumV2' THEN 'V2' WHEN recipe_version_sh = 'SyncRun_RecipeVersionEnumV3' THEN 'V3' ELSE 'Unknown' END",
//   },
//   {
...
//   },
//   {
//     sql_expression: "regexp_split_to_array(tag->>'tag_id', '\"|\\[\"|\"\\]')",
//   },
//   {
...
//   {
//     sql_expression:
//       "regexp_split_to_array(custom_fields -> 'ctype__x1260822517949_cfid', '\"|\\[\"|\"\\]')",
//   },
//   {
...
//   },
//   {
//     sql_expression: 'dim_ticket.is_spam',
//   },
//   {
//     sql_expression: 'dim_ticket.owned_by_ids',
//   },
//   {
