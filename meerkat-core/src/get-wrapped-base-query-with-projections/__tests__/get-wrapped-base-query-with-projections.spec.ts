...
describe('get-wrapped-base-query-with-projections', () => {
  ...
  describe('getWrappedBaseQueryWithProjections (useDotNotation: false)', () => {
  ...
  describe('getWrappedBaseQueryWithProjections (useDotNotation: true)', () => {
    it('should wrap base query with projections using dot notation', () => {
      const baseQuery = 'SELECT * FROM orders';
      const tableSchema = createMockTableSchema('orders', [
        { name: 'customer_id', sql: 'orders.customer_id' },
      ]);
      ...
      expect(result).toBe(
        'SELECT orders.customer_id AS "orders.customer_id", * FROM (SELECT * FROM orders) AS orders'
      );
    });

    it('should include measures in projections with dot notation', () => {
      const baseQuery = 'SELECT * FROM orders';
      const tableSchema = createMockTableSchema(
        'orders',
        [],
      ...
      expect(result).toBe(
        'SELECT orders.total AS "orders.total", * FROM (SELECT * FROM orders) AS orders'
      );
    });
    ...
    it('should handle dimension with underscore in name', () => {
      ...
      expect(result).toBe(
        'SELECT data.customer_nested_id AS "data.customer_nested_id", * FROM (SELECT * FROM data) AS data'
      );
    });
    ...
    it('should handle filters and add projections for filter members', () => {
      ...
      expect(result).toBe(
        'SELECT orders.status AS "orders.status", orders.customer_id AS "orders.customer_id", * FROM (SELECT * FROM orders) AS orders'
      );
    });
    ...
    it('should handle both dimensions and measures together', () => {
      ...
      expect(result).toBe(
        'SELECT orders.customer_id AS "orders.customer_id", orders.total AS "orders.total", * FROM (SELECT * FROM orders) AS orders'
      );
    });
    ...
    it('should not duplicate projection when filter member is already in dimensions', () => {
      ...
      expect(result).toBe(
        'SELECT orders.status AS "orders.status", * FROM (SELECT * FROM orders) AS orders'
      );
    });
    ...
    it('should handle multiple dimensions in correct order', () => {
      ...
      expect(result).toBe(
        'SELECT orders.id AS "orders.id", orders.customer_id AS "orders.customer_id", orders.status AS "orders.status", * FROM (SELECT * FROM orders) AS orders'
      );
    });
    ...
    it('should handle complex base query with subqueries', () => {
      ...
      expect(result).toBe(
        'SELECT users.email AS "users.email", * FROM (SELECT id, name FROM (SELECT * FROM users WHERE active = true) AS filtered_users) AS users'
      );
    });
    ...
    it('should handle nested filters with and/or operators', () => {
      ...
      expect(result).toBe(
        'SELECT orders.status AS "orders.status", orders.priority AS "orders.priority", orders.customer_id AS "orders.customer_id", * FROM (SELECT * FROM orders) AS orders'
      );
    });
    ...
    it('should handle filters with or operator', () => {
      ...
      expect(result).toBe(
        'SELECT orders.region AS "orders.region", orders.country AS "orders.country", orders.customer_id AS "orders.customer_id", * FROM (SELECT * FROM orders) AS orders'
      );
    });
