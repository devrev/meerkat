  ...
  describe('getCombinedTableSchema', () => {
    ...
    it('should combine multiple table schemas correctly', async () => {
      ...
      expect(result).toEqual({
        ...
        measures: [
          { __sourceTable: 'orders', name: 'total_amount', sql: 'SUM(amount)' },
          { __sourceTable: 'orders', name: 'order_count', sql: 'COUNT(*)' },
          {
            __sourceTable: 'orders',
            name: 'avg_order_value',
            sql: 'AVG(amount)',
          },
          {
            __sourceTable: 'customers',
            name: 'customer_count',
        ...
        dimensions: [
          { __sourceTable: 'orders', name: 'order_date', sql: 'created_at' },
          { __sourceTable: 'orders', name: 'status', sql: 'order_status' },
          {
            __sourceTable: 'orders',
            name: 'payment_method',
            sql: 'payment_type',
          },
          { __sourceTable: 'customers', name: 'join_date', sql: 'created_at' },
          { __sourceTable: 'customers', name: 'customer_type', sql: 'type' },
          { __sourceTable: 'customers', name: 'region', sql: 'region' },
        ],
        joins: [],
      });
    });
