...
describe('Comprehensive: Grouping', () => {
  ...
  describe('Single Dimension Grouping', () => {
    ...
    it.fails('should group by date dimension', async () => {
      const sql = `
  ...
  describe('Multi-Dimension (Composite) Grouping', () => {
    ...
    it.fails(
      'should group by three dimensions: priority + status + is_active',
      async () => {
        const sql = `
    ...
    it.fails('should group by string + boolean dimensions', async () => {
      const sql = `
  ...
  describe('Grouping with Filters', () => {
    it.fails('should group with simple filter', async () => {
      const sql = `
        SELECT priority, COUNT(*) as count
        FROM fact_all_types
