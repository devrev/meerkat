...
describe('Comprehensive: Set Operations', () => {
  ...
  describe('UNION', () => {
    ...
    it.fails('should use UNION with WHERE clauses', async () => {
      const sql = `
  ...
  describe('Set Operations with ORDER BY', () => {
    ...
    it.fails('should order by computed columns', async () => {
      const sql = `
  ...
  describe('Set Operations with Aggregates', () => {
    it.fails('should use set operations on aggregate results', async () => {
      const sql = `
