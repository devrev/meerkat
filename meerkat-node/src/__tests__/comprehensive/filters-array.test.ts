...
describe('Comprehensive: Array Filters', () => {
  ...
  describe('Array Contains Element', () => {
    it.fails('should filter array contains single tag: "backend"', async () => {
    ...
    it.fails('should filter array contains single tag: "frontend"', async () => {
      const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
    ...
    it.fails('should filter array contains single tag: "api"', async () => {
      const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
    ...
    it.fails('should filter array contains tag: "urgent"', async () => {
      const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
  ...
  describe('Array Contains Multiple Elements', () => {
    it.fails('should filter array contains "backend" AND "urgent"', async () => {
      const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
        WHERE list_contains(tags, 'backend')
    ...
    it.fails('should filter array contains "frontend" OR "api"', async () => {
      const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
        WHERE list_contains(tags, 'frontend')
  ...
  describe('Array NOT Contains Element', () => {
    it.fails('should filter array does NOT contain "urgent"', async () => {
      const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
    ...
    it.fails('should filter array does NOT contain "backend"', async () => {
      const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
  ...
  describe('Array Length/Size Queries', () => {
    it.fails('should filter by array length = 1', async () => {
      const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
    ...
    it.fails('should filter by array length = 2', async () => {
      const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
  ...
  describe('Empty and NULL Array Handling', () => {
    it.fails('should handle empty arrays', async () => {
      const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
  ...
  describe('Complex Array Combinations', () => {
    it.fails('should filter array contains + boolean filter', async () => {
      const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
        WHERE list_contains(tags, 'urgent')
    ...
    it.fails('should filter array contains + string filter', async () => {
      const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
        WHERE list_contains(tags, 'backend')
    ...
    it.fails('should filter array contains + date range', async () => {
      const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
        WHERE list_contains(tags, 'urgent')
    ...
    it.fails('should filter array contains + numeric range', async () => {
      const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
        WHERE list_contains(tags, 'frontend')
  ...
  describe('Multiple Array Conditions', () => {
    it.fails('should filter array contains at least one of multiple tags', async () => {
      const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
        WHERE list_contains(tags, 'backend')
    ...
    it.fails('should filter array contains ALL of specific tags', async () => {
      const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
        WHERE list_contains(tags, 'backend')
    ...
    it.fails('should filter complex nested array conditions', async () => {
      const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
        WHERE (
  ...
  describe('Array Aggregations and Grouping', () => {
    ...
    it.fails('should find most common tags by unnesting', async () => {
      const sql = `
  ...
  describe('Advanced Array Operations', () => {
    ...
    it.fails('should filter by array overlap with custom list', async () => {
      const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
        WHERE EXISTS (
