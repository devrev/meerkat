...
describe('Comprehensive: Array Filters', () => {
  ...
  describe('Array Contains Element', () => {
    ...
    it.fails(
      'should filter array contains single tag: "frontend"',
      async () => {
        const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
  ...
  describe('Array Contains Multiple Elements', () => {
    it.fails(
      'should filter array contains "backend" AND "urgent"',
      async () => {
        const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
  ...
  describe('Multiple Array Conditions', () => {
    it.fails(
      'should filter array contains at least one of multiple tags',
      async () => {
        const sql = `
        SELECT COUNT(*) AS count
        FROM fact_all_types
